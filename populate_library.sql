-- ==========================================================
-- NextChapter - Complete Digital Library Seed Data (Supabase Storage URLs)
-- Run this script in your Supabase SQL Editor
-- ==========================================================

-- 1. Create Public Storage Bucket for Books (if not exists)
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES ('Book-storage', 'Book-storage', true, 52428800, ARRAY['application/pdf', 'image/jpeg', 'image/png', 'image/webp'])
ON CONFLICT (id) DO UPDATE SET public = true;

-- 2. Storage Policies for Public Reading and Uploads
DROP POLICY IF EXISTS "Public Access Book-storage" ON storage.objects;
CREATE POLICY "Public Access Book-storage"
ON storage.objects FOR SELECT
USING (bucket_id = 'Book-storage');

DROP POLICY IF EXISTS "Allow All Uploads Book-storage" ON storage.objects;
CREATE POLICY "Allow All Uploads Book-storage"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'Book-storage');

DROP POLICY IF EXISTS "Allow All Updates Book-storage" ON storage.objects;
CREATE POLICY "Allow All Updates Book-storage"
ON storage.objects FOR UPDATE
USING (bucket_id = 'Book-storage');

-- 3. Populate Books Table with Supabase Storage URLs
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/pride-and-prejudice.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/frankenstein.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-great-gatsby.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/alices-adventures-in-wonderland.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/dracula.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-metamorphosis.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-picture-of-dorian-gray.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/jane-eyre.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/a-tale-of-two-cities.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-time-machine.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-war-of-the-worlds.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/moby-dick.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/crime-and-punishment.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-strange-case-of-dr-jekyll-and-mr-hyde.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/little-women.pdf',
...
(
    ...
    'https://xrufzgezmqjfwjehqgal.supabase.co/storage/v1/object/public/Book-storage/the-adventures-of-tom-sawyer.pdf',
